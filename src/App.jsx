  ...
  <div className="min-h-screen bg-slate-50 px-6 py-10 flex items-center justify-center">
    <div className="w-full max-w-2xl rounded-3xl border border-amber-200 bg-white p-8 shadow-xl">
      ...
      <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-5 text-sm text-slate-700">
        <p className="mb-2 font-semibold">Vercel'de yapmanız gerekenler</p>
        <ol className="list-decimal space-y-2 pl-5">
          <li>
            Firebase Console / Project settings / Your apps / Web app config alanını açın.
          </li>
          <li>
            Lokalinizde çalışan <span className="font-mono">.env.local</span> dosyası varsa aynı değerleri kopyalayın.
          </li>
          <li>
            Vercel / Project Settings / Environment Variables bölümünde tüm
            <span className="mx-1 font-mono">VITE_FIREBASE_*</span>
            değişkenlerini en az
            <span className="mx-1 font-semibold">Production</span>
            ortamına ekleyin.
          </li>
          <li>
            Değişkenleri ekledikten sonra
            <span className="mx-1 font-semibold">Redeploy</span>
            çalıştırın; eski deployment bu değerleri sonradan otomatik almaz.
          </li>
        </ol>
      </div>
    </div>
